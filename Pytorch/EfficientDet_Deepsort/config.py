...
video_src = os.path.join(dirname, "Pytorch/videos/input/video_2.mp4")
video_output = os.path.join(dirname, "Pytorch/videos/output/video_2_out.mp4")

text_output = os.path.join(dirname, "Pytorch/videos/ouput/video_2_out.csv")
...
# TRACKER ##############################################################################################################
REID_CKPT = os.path.join(dirname, "Pytorch/pretrained_models/ckpt.t7")
