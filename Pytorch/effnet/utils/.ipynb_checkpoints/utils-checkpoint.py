...
def preprocess_video_frame(frame, max_size=512, mean=(0.485, 0.456, 0.406), std=(0.229, 0.224, 0.225)):
    ori_img = frame.copy()
    normalized_img = (ori_img[..., ::-1] / 255 - mean) / std
    framed_img, new_w, new_h, old_w, old_h, padding_w, padding_h = aspectaware_resize_padding(normalized_img, max_size, max_size, means=None)
...
def postprocess(x, anchors, regression, classification, regressBoxes, clipBoxes, threshold, iou_threshold):
    ...
    for i in range(x.shape[0]):
      ...
      #  print("i:", i)
       ...
       # print('transformed_anchors_per : ' ,transformed_anchors_per)
