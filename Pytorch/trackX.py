...
from effnet.backbone import EfficientDetBackbone
...
if __name__ == '__main__':
    ...
    state_dict = torch.load('/workspace/logs/mot/2/mot_pytorch/efficientdet-d2_39_85040.pth')
   ...
   # state_dict = torch.load('/workspace/logs/mot/3/mot_pytorch_residual/efficientdet-d3_46_98500.pth')
    state_dict = torch.load('/workspace/save/efficientdet-d2_49_26550.pth')
